    ...
    public class WhenAddingATableToAWorksheet : BaseFixture
    {
        ...
        public void ThenTableAddedSuccessfully()
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                Check.That(worksheet.Cell("D7").Value).IsEqualTo("1");
                Check.That(worksheet.Cell("E7").Value).IsEqualTo("2");
                Check.That(worksheet.Cell("F7").Value).IsEqualTo("3");
                Check.That(worksheet.Cell("G7").Value).IsEqualTo("4");
                Check.That(worksheet.Cell("D8").Value).IsEqualTo("5");
                Check.That(worksheet.Cell("E8").Value).IsEqualTo("6");
                Check.That(worksheet.Cell("F8").Value).IsEqualTo("7");
                Check.That(worksheet.Cell("G8").Value).IsEqualTo("8");
